...
@section('activePageCreate') active @endsection
...
@section('content')
    <form action="{{route('page.store')}}" method="POST" name="createpage" enctype="multipart/form-data">
        @csrf
        <div class="box-body">
