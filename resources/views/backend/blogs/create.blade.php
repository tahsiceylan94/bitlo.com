...
@section('activeBlogCreate') active @endsection
...
@section('breadcrumb')
    <ol class="breadcrumb">
        <li><a href="{{route('blog.index')}}"><i class="fa fa-paper-plane"></i> Blog</a></li>
        <li class="active">Ekle</li>
    </ol>
@endsection

@section('content')
    <form action="{{route('blog.store')}}" method="POST" name="createblog" enctype="multipart/form-data">
        @csrf
        <div class="box-body">
