...
@section('pagetitle') Footer @endsection

@section('breadcrumb')
    <ol class="breadcrumb">
        <li><a href="{{route('zeplin.index')}}"><i class="fa fa-bars"></i> Footer</a></li>
    </ol>
@endsection
...
@section('content')
    <div class="box-body">
        <div align="right">
            {{--<a href="{{route('footer.create')}}"><button class="btn btn-success">Ekle</button></a>--}}
        </div>
            ...
            <tbody id="sortable">
                @foreach($data['footers'] as $key)
                    <tr id="item-{{$key->id}}">
                        ...
                        <td class="sortable" style="text-align: center;"><a href="{{route('footer.edit',$key->id)}}"><i class="fa fa-edit"></i></a></td>
                    </tr>
                @endforeach
            </tbody>
        </table>
